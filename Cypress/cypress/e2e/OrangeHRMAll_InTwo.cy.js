// 1 Login
beforeEach('Login-OrangeHRM',function(){
...
// 2 AddDeleteEmployee
it('Add_Delete_Employee-OrangeHRM',function(){
...
// 3 AddJobTitle
it('AddJobTitle-OrangeHRM',function(){
...
cy.wait(2000);
cy.get(':nth-child(2) > .oxd-input').type("SE",{delay:200}); //Enter job title 
cy.wait(2000);
cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-textarea').type("SE",{delay:200}); //Enter job Describtion 
cy.wait(2000);
// Uploading file 
cy.log("uploading file");
cy.get('[type="file"]').selectFile('cypress/fixtures/MyResume.pdf',{force:true}); // Upload file 
cy.wait(2000);
cy.get(':nth-child(4) > .oxd-input-group > :nth-child(2) > .oxd-textarea').type("Good Job",{delay:200}); //Enter Note 
cy.wait(2000);
...
// 5 Logout
afterEach('Logout-OrangeHRM',function(){
